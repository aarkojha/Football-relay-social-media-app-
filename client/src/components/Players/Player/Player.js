        ...
        <Card className={classes.card} raised elevation={6}>
            ...
            {(user?.result?.googleId === player?.creator || user?.result?._id === player?.creator) && (
                <div className={classes.overlay2}>
                    <Button style={{ color: 'white', transform: 'rotate(90deg)' }} size="small" onClick={() => { setCurrentId(player._id) }}>
            ...
            {/* <CardContent>
                <Typography variant="body2" component="p">{player.description}</Typography>
            </CardContent> */}
